...
public final class PostgreSQLBinaryProtocolValueFactory {
    ...
    private static void setUnspecifiedBinaryProtocolValue() {
        ...
        BINARY_PROTOCOL_VALUES.put(PostgreSQLBinaryColumnType.POSTGRESQL_TYPE_UNSPECIFIED, binaryProtocolValue);
    }
    ...
    private static void setInt8BinaryProtocolValue() {
        ...
        BINARY_PROTOCOL_VALUES.put(PostgreSQLBinaryColumnType.POSTGRESQL_TYPE_INT8, binaryProtocolValue);
    }
    ...
    private static void setInt4BinaryProtocolValue() {
        ...
        BINARY_PROTOCOL_VALUES.put(PostgreSQLBinaryColumnType.POSTGRESQL_TYPE_INT4, binaryProtocolValue);
    }
    ...
    private static void setInt2BinaryProtocolValue() {
        ...
        BINARY_PROTOCOL_VALUES.put(PostgreSQLBinaryColumnType.POSTGRESQL_TYPE_INT2, binaryProtocolValue);
    }
    ...
    private static void setDoubleBinaryProtocolValue() {
        ...
        BINARY_PROTOCOL_VALUES.put(PostgreSQLBinaryColumnType.POSTGRESQL_TYPE_FLOAT8, binaryProtocolValue);
    }
