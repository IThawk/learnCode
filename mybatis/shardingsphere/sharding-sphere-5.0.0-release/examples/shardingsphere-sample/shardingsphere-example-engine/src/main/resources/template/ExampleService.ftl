...
import org.apache.shardingsphere.example.${feature}.${framework?replace('-', '.')}.repository.OrderItemRepository;
import org.apache.shardingsphere.example.${feature}.${framework?replace('-', '.')}.repository.OrderRepository;
