...
import com.macro.mall.search.repository.ProductElasticsearchDao;
...
//        return productRepository.productElasticsearchDao(keyword, keyword, keyword, pageable);
//    }

    @Override
    public Page<EsProduct> search(String keyword, Integer pageNum, Integer pageSize) {
        Pageable pageable = PageRequest.of(pageNum, pageSize);
        return productElasticsearchDao.search(keyword, pageNum, pageSize);
    }
...
//
//        EsProduct esProduct = new EsProduct();
//        Document document = esProduct.getClass().getAnnotation(Document.class)    ;
...
////        }
//
//        return SearchTools.searchResponseToPage(searchResponse,pageable,EsProduct.class);
//    }
