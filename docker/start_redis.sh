...
sudo docker run -p 6379:6379 --name redis -v /C/docker/data/redis/log:/log -v /C/docker/data/redis/data:/data -v /C/docker/data/redis/redis.conf:/etc/redis/redis.conf -d redis:latest redis-server /etc/redis/redis.conf