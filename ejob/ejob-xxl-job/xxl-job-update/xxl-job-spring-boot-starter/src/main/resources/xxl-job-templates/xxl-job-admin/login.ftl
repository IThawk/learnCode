...
<head>
    ...
    <link rel="stylesheet" href="${request.contextPath}/xxl-job-static/adminlte/plugins/iCheck/square/blue.css">
...
<script src="${request.contextPath}/xxl-job-static/adminlte/plugins/iCheck/icheck.min.js"></script>
<script src="${request.contextPath}/xxl-job-static/js/login.1.js"></script>
