...
<#-- echarts -->
<script src="${request.contextPath}/xxl-job-static/plugins/echarts/echarts.common.min.js"></script>
<script src="${request.contextPath}/xxl-job-static/js/index.js"></script>
</body>
</html>
