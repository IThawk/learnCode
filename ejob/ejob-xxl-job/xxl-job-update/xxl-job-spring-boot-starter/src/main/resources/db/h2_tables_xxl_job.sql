...
DROP SEQUENCE xxl_job_log_report_id_seq;
...
DROP SEQUENCE xxl_job_logglue_id_seq;
...
DROP SEQUENCE xxl_job_user_id_seq;
...
INSERT INTO xxl_job_group(app_name, title, address_type, address_list) VALUES ('xxl-job-executor-test', '示例执行器', 0, NULL);
