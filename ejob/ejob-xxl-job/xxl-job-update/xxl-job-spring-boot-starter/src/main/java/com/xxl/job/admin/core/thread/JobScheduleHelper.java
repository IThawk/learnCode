...
public class JobScheduleHelper {
        ...
        scheduleThread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                while (!scheduleThreadToStop) {
                    ...
                    boolean preReadSuc = doScanJob(preReadCount);
    ...
    public boolean doScanJob(int preReadCount) {
        // Scan Job
        ...
        try {
            ...
            // 查询5秒钟之内需要触发的任务
            List<XxlJobInfo> scheduleList = XxlJobAdminConfig.getAdminConfig().getXxlJobInfoDao().scheduleJobQuery(
