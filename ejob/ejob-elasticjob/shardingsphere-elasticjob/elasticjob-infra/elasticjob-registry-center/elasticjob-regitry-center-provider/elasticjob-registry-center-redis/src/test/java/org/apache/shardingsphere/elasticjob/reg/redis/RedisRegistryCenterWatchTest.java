...
public final class RedisRegistryCenterWatchTest {
    
    private static final RedisConfiguration ZOOKEEPER_CONFIGURATION = new RedisConfiguration(EmbedTestingServer.getConnectionString(), RedisRegistryCenterWatchTest.class.getName());
