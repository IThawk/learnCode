...
public final class RedisRegistryCenterModifyTest {
    
    private static final RedisConfiguration ZOOKEEPER_CONFIGURATION = new RedisConfiguration(EmbedTestingServer.getConnectionString(), RedisRegistryCenterModifyTest.class.getName());
    ...
    public void assertPersistEphemeral() throws Exception {
        ...
        assertThat(client.getData().forPath("/" + RedisRegistryCenterModifyTest.class.getName() + "/persist"), is("persist_value".getBytes()));
        assertNull(client.checkExists().forPath("/" + RedisRegistryCenterModifyTest.class.getName() + "/ephemeral"));
        zkRegCenter.init();
    }
    ...
    public void assertPersistSequential() throws Exception {
        ...
        client.start();
        client.blockUntilConnected();
        List<String> actual = client.getChildren().forPath("/" + RedisRegistryCenterModifyTest.class.getName() + "/sequential");
    ...
    public void assertPersistEphemeralSequential() throws Exception {
        ...
        zkRegCenter.close();
        actual = client.getChildren().forPath("/" + RedisRegistryCenterModifyTest.class.getName() + "/sequential");
