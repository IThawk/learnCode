...
public final class RedisRegistryCenterMiscellaneousTest {
    
    private static final RedisConfiguration ZOOKEEPER_CONFIGURATION =
            new RedisConfiguration(org.apache.shardingsphere.elasticjob.reg.redis.fixture.EmbedTestingServer.getConnectionString(), RedisRegistryCenterMiscellaneousTest.class.getName());
    ...
    public void assertGetRawClient() {
        ...
        assertThat(((CuratorFramework) zkRegCenter.getRawClient()).getNamespace(), is(RedisRegistryCenterMiscellaneousTest.class.getName()));
    }
    ...
    public void assertGetZkConfig() {
        RedisRegistryCenter zkRegCenter = new RedisRegistryCenter(ZOOKEEPER_CONFIGURATION);
