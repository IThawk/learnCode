...
import org.apache.shardingsphere.elasticjob.reg.redis.exception.RedisIgnoredExceptionProvider;
...
public final class ZookeeperCuratorIgnoredExceptionProviderTest {
    ...
    public void assertIgnoredException() {
        ...
        assertThat(new RedisIgnoredExceptionProvider().getIgnoredExceptions(), is(expected));
    }
}
