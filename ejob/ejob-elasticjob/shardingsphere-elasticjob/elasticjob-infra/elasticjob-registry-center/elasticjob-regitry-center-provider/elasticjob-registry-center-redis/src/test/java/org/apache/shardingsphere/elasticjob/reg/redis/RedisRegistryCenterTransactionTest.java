...
public final class RedisRegistryCenterTransactionTest {
    
    private static final RedisConfiguration ZOOKEEPER_CONFIGURATION =
            new RedisConfiguration(org.apache.shardingsphere.elasticjob.reg.redis.fixture.EmbedTestingServer.getConnectionString(), RedisRegistryCenterTransactionTest.class.getName());
