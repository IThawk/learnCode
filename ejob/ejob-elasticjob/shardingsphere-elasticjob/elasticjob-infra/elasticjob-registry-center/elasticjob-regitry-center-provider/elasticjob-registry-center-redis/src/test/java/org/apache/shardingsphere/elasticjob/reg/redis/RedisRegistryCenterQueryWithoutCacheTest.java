...
public final class RedisRegistryCenterQueryWithoutCacheTest {
    
    private static final RedisConfiguration ZOOKEEPER_CONFIGURATION =
            new RedisConfiguration(org.apache.shardingsphere.elasticjob.reg.redis.fixture.EmbedTestingServer.getConnectionString(), RedisRegistryCenterQueryWithoutCacheTest.class.getName());
