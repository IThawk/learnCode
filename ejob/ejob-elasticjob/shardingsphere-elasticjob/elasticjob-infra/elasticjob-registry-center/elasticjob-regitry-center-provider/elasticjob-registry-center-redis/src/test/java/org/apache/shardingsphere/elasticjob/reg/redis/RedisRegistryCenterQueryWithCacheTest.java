...
public final class RedisRegistryCenterQueryWithCacheTest {
    
    private static final RedisConfiguration ZOOKEEPER_CONFIGURATION =
            new RedisConfiguration(org.apache.shardingsphere.elasticjob.reg.redis.fixture.EmbedTestingServer.getConnectionString(), RedisRegistryCenterQueryWithCacheTest.class.getName());
