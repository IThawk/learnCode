...
public final class RedisRegistryCenterExecuteInLeaderTest {
    
    private static final RedisConfiguration ZOOKEEPER_CONFIGURATION =
            new RedisConfiguration(org.apache.shardingsphere.elasticjob.reg.redis.
                    fixture.EmbedTestingServer.getConnectionString(),
                    RedisRegistryCenterExecuteInLeaderTest.class.getName());
