...
public final class RedisConfigurationTest {
    
    @Test
    public void assertNewZookeeperConfigurationForServerListsAndNamespace() {
        RedisConfiguration zkConfig = new RedisConfiguration("localhost:6379", "myNamespace");
        assertThat(zkConfig.getServerLists(), is("localhost:6379"));
