package com.ithawk.demo.spring.v1.crud.daosupport;
...
public class EmployeeDaoImpl extends BaseDao implements EmployeeMapper {
    ...
    public Employee selectByPrimaryKey(Integer empId) {
        Employee emp = (Employee) this.selectOne("com.ithawk.demo.spring.v1.crud.dao.EmployeeMapper.selectByPrimaryKey",empId);
        return emp;
    }
