package com.ithawk.demo.spring.aop.aspect;
...
public class ArgsAspect {
    ...
    @Pointcut("execution(* com.ithawk.demo.spring.aop.service..*(..))")
    public void aspect() {
    }

    //配置前置通知,拦截返回值为com.ithawk.demo.spring.aop.model.Member的方法
    @Before("execution(com.ithawk.demo.spring.aop.model.Member com.ithawk.demo.spring.aop.service..*(..))")
    public void beforeReturnUser(JoinPoint joinPoint) {
        log.info("beforeReturnUser " + joinPoint);
    }

    //配置前置通知,拦截参数为com.ithawk.demo.spring.aop.model.Member的方法
    @Before("execution(* com.ithawk.demo.spring.aop.service..*(com.ithawk.demo.spring.aop.model.Member))")
