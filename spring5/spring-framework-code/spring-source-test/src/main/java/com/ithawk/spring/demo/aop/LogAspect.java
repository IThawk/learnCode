package com.ithawk.spring.demo.aop;
...
public class LogAspect {
	...
	//前置通知  增强方法/增强器
	@Before("execution(* com.ithawk.spring.demo.aop.HelloService.sayHello(..))")
	...
	//返回通知
	@AfterReturning(value = "execution(* com.ithawk.spring.demo.aop.HelloService.sayHello(..))",returning = "result")
	...
	//后置通知
	@After("execution(* com.ithawk.spring.demo.aop.HelloService.sayHello(..))")
	...
	//异常
	@AfterThrowing(value = "execution(* com.ithawk.spring.demo.aop.HelloService.sayHello(..))",throwing = "e")
