package com.ithawk.demo.spring.v1.vip.aop.aspect;
...
public class ArgsAspect {
    ...
    @Before("execution(com.ithawk.demo.spring.v1.vip.model.Member com.gupaoedu.vip.aop.service..*(..))")
    public void beforeReturnUser(JoinPoint joinPoint) {
        log.info("beforeReturnUser " + joinPoint);
    }

    //配置前置通知,拦截参数为com.gupaoedu.vip.model.Member的方法
    @Before("execution(* com.gupaoedu.vip.aop.service..*(com.ithawk.demo.spring.v1.vip.model.Member))")
