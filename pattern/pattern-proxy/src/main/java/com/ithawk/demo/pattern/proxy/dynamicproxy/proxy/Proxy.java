...
public class Proxy {
    ...
    public static Object newProxyInstance(ProxyClassLoader classLoader, Class<?>[] interfaces, InvocationHandler h) {
        try {
            //1、动态生成源代码.java文件
...
//           System.out.println(filePath);
    ...
    private static String generateSrc(Class<?>[] interfaces) {
        ...
        sb.append("package com.ithawk.demo.pattern.proxy.dynamicproxy.proxy;" + ln);
        sb.append("import com.ithawk.demo.pattern.proxy.Person;" + ln);
