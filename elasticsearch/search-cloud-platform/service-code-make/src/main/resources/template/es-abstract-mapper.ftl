...
import ${basePackage}.core.EsBaseQuery;
import ${basePackage}.core.CommonEntity;
import ${basePackage}.core.SearchTools;
import ${basePackage}.core.EsDocument;
import ${basePackage}.core.EsFiled;
import ${basePackage}.core.EsFieldType;
