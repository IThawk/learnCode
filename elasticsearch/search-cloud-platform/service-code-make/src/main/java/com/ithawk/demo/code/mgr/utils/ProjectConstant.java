...
public final class ProjectConstant {
    public static final String BASE_PACKAGE = "com.ithawk.mgr";//项目基础包名称，根据自己公司的项目修改
    
    public static final String REDIS_PRE = "search-mgr_";

    public static final String MODEL_PACKAGE = BASE_PACKAGE + ".model";//Model所在包
    public static final String MAPPER_PACKAGE = BASE_PACKAGE + ".dao";//Mapper所在包
    public static final String ES_MAPPER_PACKAGE = BASE_PACKAGE + ".esDao";//Mapper所在包

    public static final String SERVICE_PACKAGE = BASE_PACKAGE + ".service";//Service所在包
    public static final String SERVICE_IMPL_PACKAGE = SERVICE_PACKAGE + ".impl";//ServiceImpl所在包

    public static final String CORE_PACKAGE = BASE_PACKAGE + ".core";//ServiceImpl所在包

    public static final String CONFIG_PACKAGE = BASE_PACKAGE + ".config";//ServiceImpl所在包
