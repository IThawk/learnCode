...
public class JConsoleResources_zh_CN extends JConsoleResources {
	...
	{"Local Process:.mnemonic", 'L'},
        ...
        {"MBeansTab.compositeNavigationMultiple", "\u590d\u5408\u6d4f\u89c8 {0}/{1}"},
        {"MBeansTab.compositeNavigationSingle", "\u590d\u5408\u6d4f\u89c8"},
        ...
        {"MBeansTab.tabularNavigationMultiple", "\u8868\u683c\u5f0f\u6d4f\u89c8 {0}/{1}"},
        {"MBeansTab.tabularNavigationSingle", "\u8868\u683c\u5f0f\u6d4f\u89c8"},
        {"MBeansTab.unsubscribeNotificationsButton", "\u672a\u8ba2\u9605(U)"},
