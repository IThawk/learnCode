...
ALTER TABLE orm_user ALTER id SET DEFAULT NEXTVAL('orm_user_id_seq');

COMMENT ON COLUMN "public"."orm_user"."id" IS 'Id（主键）';
...
ALTER TABLE orm_role ALTER id SET DEFAULT NEXTVAL('orm_role_id_seq');
