...
public class WriteTest {
    ...
    public void simpleWrite() {
        ...
        // 写法1 JDK8+
        // since: 3.0.0-beta1
        String fileName = EasyexcelUtils.getPath() + "simpleWrite" + System.currentTimeMillis() + ".xlsx";
        ...
        // 写法2
        fileName = EasyexcelUtils.getPath() + "simpleWrite" + System.currentTimeMillis() + ".xlsx";
        // 这里 需要指定写用哪个class去写，然后写到第一个sheet，名字为模板 然后文件流会自动关闭
        // 如果这里想使用03 则 传入excelType参数即可
    ...
    public void excludeOrIncludeWrite() {
        String fileName = EasyexcelUtils.getPath() + "excludeOrIncludeWrite" + System.currentTimeMillis() + ".xlsx";
        ...
        fileName = EasyexcelUtils.getPath() + "excludeOrIncludeWrite" + System.currentTimeMillis() + ".xlsx";
    ...
    public void indexWrite() {
        String fileName = EasyexcelUtils.getPath() + "indexWrite" + System.currentTimeMillis() + ".xlsx";
        // 这里 需要指定写用哪个class去写，然后写到第一个sheet，名字为模板 然后文件流会自动关闭
    ...
    public void complexHeadWrite() {
        String fileName = EasyexcelUtils.getPath() + "complexHeadWrite" + System.currentTimeMillis() + ".xlsx";
        // 这里 需要指定写用哪个class去写，然后写到第一个sheet，名字为模板 然后文件流会自动关闭
    ...
    public void repeatedWrite() {
        // 方法1: 如果写到同一个sheet
        String fileName = EasyexcelUtils.getPath() + "repeatedWrite" + System.currentTimeMillis() + ".xlsx";
        // 这里 需要指定写用哪个class去写
        try (ExcelWriter excelWriter = EasyExcel.write(fileName, DemoData.class).build()) {
        ...
        fileName = EasyexcelUtils.getPath() + "repeatedWrite" + System.currentTimeMillis() + ".xlsx";
        // 这里 指定文件
        try (ExcelWriter excelWriter = EasyExcel.write(fileName, DemoData.class).build()) {
    ...
    public void converterWrite() {
        String fileName = EasyexcelUtils.getPath() + "converterWrite" + System.currentTimeMillis() + ".xlsx";
        // 这里 需要指定写用哪个class去写，然后写到第一个sheet，名字为模板 然后文件流会自动关闭
    ...
    public void imageWrite() throws Exception {
        String fileName = EasyexcelUtils.getPath() + "imageWrite" + System.currentTimeMillis() + ".xlsx";
        ...
        String imagePath = EasyexcelUtils.getPath() + "converter" + File.separator + "img.jpg";
    ...
    public void templateWrite() {
        String templateFileName = EasyexcelUtils.getPath() + "demo" + File.separator + "demo.xlsx";
        String fileName = EasyexcelUtils.getPath() + "templateWrite" + System.currentTimeMillis() + ".xlsx";
        // 这里 需要指定写用哪个class去写，然后写到第一个sheet，名字为模板 然后文件流会自动关闭
    ...
    public void widthAndHeightWrite() {
        String fileName = EasyexcelUtils.getPath() + "widthAndHeightWrite" + System.currentTimeMillis() + ".xlsx";
        // 这里 需要指定写用哪个class去写，然后写到第一个sheet，名字为模板 然后文件流会自动关闭
    ...
    public void annotationStyleWrite() {
        String fileName = EasyexcelUtils.getPath() + "annotationStyleWrite" + System.currentTimeMillis() + ".xlsx";
        // 这里 需要指定写用哪个class去写，然后写到第一个sheet，名字为模板 然后文件流会自动关闭
    ...
    public void handlerStyleWrite() {
        ...
        String fileName = EasyexcelUtils.getPath() + "handlerStyleWrite" + System.currentTimeMillis() + ".xlsx";
        // 头的策略
        ...
        // @since 3.0.0-beta2
        fileName = EasyexcelUtils.getPath() + "handlerStyleWrite" + System.currentTimeMillis() + ".xlsx";
        EasyExcel.write(fileName, DemoData.class)
    ...
    public void mergeWrite() {
        // 方法1 注解
        String fileName = EasyexcelUtils.getPath() + "mergeWrite" + System.currentTimeMillis() + ".xlsx";
        // 在DemoStyleData里面加上ContentLoopMerge注解
        // 这里 需要指定写用哪个class去写，然后写到第一个sheet，名字为模板 然后文件流会自动关闭
        EasyExcel.write(fileName, DemoMergeData.class).sheet("模板").doWrite(data());

        // 方法2 自定义合并单元格策略
        fileName = EasyexcelUtils.getPath() + "mergeWrite" + System.currentTimeMillis() + ".xlsx";
    ...
    public void tableWrite() {
        String fileName = EasyexcelUtils.getPath() + "tableWrite" + System.currentTimeMillis() + ".xlsx";
    ...
    public void dynamicHeadWrite() {
        String fileName = EasyexcelUtils.getPath() + "dynamicHeadWrite" + System.currentTimeMillis() + ".xlsx";
    ...
    public void longestMatchColumnWidthWrite() {
        String fileName =
            EasyexcelUtils.getPath() + "longestMatchColumnWidthWrite" + System.currentTimeMillis() + ".xlsx";
        // 这里 需要指定写用哪个class去写，然后写到第一个sheet，名字为模板 然后文件流会自动关闭
    ...
    public void variableTitleWrite() {
        // 写法1
        String fileName = EasyexcelUtils.getPath() + "variableTitleWrite" + System.currentTimeMillis() + ".xlsx";
        // 这里 需要指定写用哪个class去写，然后写到第一个sheet，名字为模板 然后文件流会自动关闭
    ...
    public void noModelWrite() {
        // 写法1
        String fileName = EasyexcelUtils.getPath() + "noModelWrite" + System.currentTimeMillis() + ".xlsx";
        // 这里 需要指定写用哪个class去写，然后写到第一个sheet，名字为模板 然后文件流会自动关闭
