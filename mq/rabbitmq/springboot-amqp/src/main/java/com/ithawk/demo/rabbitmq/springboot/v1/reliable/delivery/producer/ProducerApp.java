package com.ithawk.demo.rabbitmq.springboot.v1.reliable.delivery.producer;
 ...
 * 消息投递的可靠性保证
 */
@ComponentScan(basePackages = "com.ithawk.demo.spring.v1.reliable.delivery.producer")
